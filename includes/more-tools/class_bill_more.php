<?php // namespace multidealer_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
add_action("init", "multidealer_bill_more");
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class multidealer_Bill_Minozzi_Add_Ajax_Url
{
...
$multidealer_bill_minozzi_add_ajax_url = new multidealer_Bill_Minozzi_Add_Ajax_Url();
class multidealer_Bill_show_more_plugins
{
    //
    public function __construct()
    {
        ...
        // add_action('wp_ajax_bill_install_plugin2', array('\multidealer_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
        ...
        // work add_action('wp_ajax_bill_install_plugin2', '\multidealer_BillMore\bill_install_plugin2');
    }
...
$show_more_plugins = new multidealer_Bill_show_more_plugins();
// } // end namespace
class multidealer_PluginInstaller
{
    public function __construct()
    {
    ...
    public function bill_install_plugin2()
    {
        ...
        $plugin = $slug;
        $skin = new \multidealer_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new multidealer_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class multidealer_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new multidealer_bill_install_QuietSkin();
